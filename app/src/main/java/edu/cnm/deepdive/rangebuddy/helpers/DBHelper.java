...
public class DBHelper extends OrmLiteSqliteOpenHelper {
   ...
   //     }
        ...
        public void populateDB() throws SQLException {
            ...
            engagements.setNameOfEngagement("test engagement 1");
            ...
            engagements.setClickValueWindage(.25);
            engagements.setClickValueElevate(1.63);
            ...
            engagements.setCaliber("5.56x45");
            engagements.setNameOfEngagement("test engagement 2");
            engagements.setLength(20);
            engagements.setGrains(62);
            engagements.setVelocity(2927);
            engagements.setDistance(200);
            ...
            engagements = new Engagement();
            engagements.setCaliber("5.56x45");
            engagements.setNameOfEngagement("test engagement 3");
            engagements.setLength(20);
            engagements.setGrains(62);
            engagements.setVelocity(2927);
            engagements.setDistance(200);
